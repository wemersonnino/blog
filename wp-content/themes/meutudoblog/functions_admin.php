    ...
    switch ($_GET['template']) {
        case 'default': {
            $meta_query[] = [
                ...
                'value' => ['sitemap.php', 'page-templates/calculadoras.php', 'page-templates/calculadora.php'],
                'compare' => 'NOT IN'
            ];
            break;
        }
        case 'calculator': {
            $meta_query[] = [
                'key' => '_wp_page_template',
                'value' => ['page-templates/calculadoras.php', 'page-templates/calculadora.php'],
                'compare' => 'IN'
            ];
            break;
        }
        default:
            $meta_query[] = [
                'key' => '_wp_page_template',
                'value' => sanitize_text_field($_GET['template']) . ".php"
            ];
    }
