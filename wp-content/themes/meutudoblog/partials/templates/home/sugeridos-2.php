<section class="home-sugeridos sugeridos-2">
    <div class="container">
    <div class="navegacao">
      ...
      <h2 class="titulo"><?php the_field('sugeridos-2-titulo'); ?></h2>
    ...
    <div class="posts">
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <?php $sugeridos = get_field('sugeridos-2-postagens') ? array_slice(get_field('sugeridos-2-postagens'), 0, 4) : null; ?>
          <?php if ($sugeridos) : ?>
          ...
          <?php $postsLeft = 4 - ($sugeridos ? count($sugeridos) : 0); if ($postsLeft > 0) : ?>
            <?php $posts = new WP_Query(array(
              ...
              'orderby' => 'date',
              'order' => 'DESC',
              'category__in' => get_field('sugeridos-2-categorias'),
...
<script>
  window.addEventListener('DOMContentLoaded', function() {
    jQuery(function($) {
      var swiper = new Swiper('section.home-sugeridos.sugeridos-2 .swiper-container', {
        slidesPerView: 1.5,
        spaceBetween: 30,
        simulateTouch: false,
      ...
      $('section.home-sugeridos.sugeridos-2 .botao-anterior').click(function(e) {
        e.preventDefault();
        swiper.slidePrev();
      });
      $('section.home-sugeridos.sugeridos-2 .botao-proximo').click(function(e) {
        e.preventDefault();
        swiper.slideNext();
      });
    });
