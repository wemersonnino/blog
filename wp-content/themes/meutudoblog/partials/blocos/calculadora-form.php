<?php
const FERRAMENTAS_CALCULADORA_DEV_MODE = true;
function edit_the_calculadora($content){
    global $post,$field, $field_label, $input_html, $tag_name_value, $current_user, $post_title;
...
<section id="box-calculadora" class="calculadora">
              <header id="titulo-calculadora">
                <h4><?php the_title('Cálculo de Margem Consignável') ?></h4>
              </header>
