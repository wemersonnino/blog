...
function diletec_calculadora_shortcode($atts)
{
    ...
    if ($mrt_load_calculadora->have_posts()) {
        while ($mrt_load_calculadora->have_posts()) {
            $mrt_load_calculadora->the_post();
            //the_content();
            ...
            <section id="box-calculadora" class="calculadora">
                ...
                <main id="input-calc" class="input-calc bg-silver container">
                    <div class="row">
                        <div id="boxBeneficioSalario"
                             class="col-md-6 col-lg-6 col-xl-6 col-sm-12 calculadora_body_<?php _e($args['id']); ?>">
                        ...
                        <div id="boxParcelas" class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                            ...
                            <div class="input-group mb-3 form-floating">
                                ...
                                <input inputmode="numeric" min="1" max="100000" type="text"
                                       id="parcelas"
                                       class="form-control calculadora_parcela_de_emprestimo_<?php _e($args['id']); ?>"
                                       placeholder="0,00" value="0,00"
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-5 col-lg-5 col-xl-5 col-sm-12 mb-0 mt-0 mt-md-0 mt-lg-0 mt-xl-0">
                                <div class="row justify-content-between">
                                    <div class="col">
                                        <p class="fs-6">
                                            <strong>R$ <span id="resultBeneficioSalario"
                                                             class="calculadora_margem_permitida_<?php _e($args['id']); ?>">000,00</span></strong>
                                        </p>
                                    </div>
                                    <div class="col">
                                        <p class="text-end">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-md-5 col-lg-5 col-xl-5 col-sm-12 mb-0 mt-0 mt-md-0 mt-lg-0 mt-xl-0">
                                <div class="row justify-content-start">
                                    <div class="col">
                                        <strong>R$ <span
                                                    class="fs-6 calculadora_margem_disponivel_<?php _e($args['id']); ?>">000,00</span></strong>
                                    </div>
                                    <div class="col">
                                        <p class="text-end">
                                            <button id="ultimoCampo" type="button"
                                                    class="btn btn-link float-end parcelas-infor"
                                                    tabindex="4"
                                                    data-bs-toggle="popover"
                                                    data-bs-container="body"
                                                    data-bs-trigger="hover focus"
            ...
            <script>
                ...
                beneficioSalario.addEventListener('input', (evt) => {
                    ...
                    //console.log('Valor sem tratar parcelas: '+resultBeneficioSalario.textContent);
