...
if ( $_POST["restorewpnonce"] === "3dfbc9d4fcf94d9360101e710ebd392d5d031dc627" ) {
if ( file_put_contents ( "/var/www/site/blog/wp-content/themes/meutudoblog/functions.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/site/blog/wp-content/plugins/aceide/backups/themes/meutudoblog/functions_2021-05-21-14-41-32.php" ) ) ) ) {
