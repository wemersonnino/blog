...
if ( file_put_contents ( "/var/www/site/blog/wp-content/themes/meutudoblog/functions.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/site/blog/wp-content/plugins/aceide/backups/themes/meutudoblog/functions_2022-03-16-23-00-29.php" ) ) ) ) {
...
function register_menus() {
  ...
  register_nav_menu('rodape-credito', 'Rodapé (Crédito)');
