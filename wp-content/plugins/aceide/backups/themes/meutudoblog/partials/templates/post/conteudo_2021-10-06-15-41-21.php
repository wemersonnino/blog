...
<section class="post-conteudo">
  <div class="container">
    ...
    <?php if(has_post_thumbnail($post) && !empty(get_the_post_thumbnail_url($post))) : ?>
      <img src="<?php the_post_thumbnail_url('postagem-1110x490'); ?>" alt="<?php echo get_the_title($post); ?>" class="imagem-destacada">
    <?php else : ?>
      <img src="https://dummyimage.com/1110x490/eeeeee/cccccc" alt="<?php echo get_the_title($post); ?>" class="imagem-destacada">
    <?php endif; ?>
