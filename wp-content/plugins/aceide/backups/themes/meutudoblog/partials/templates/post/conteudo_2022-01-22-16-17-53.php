...
<section class="post-conteudo">
  <div class="container">
    ...
    <span class="detalhes"><span class="author"><?php echo get_the_author(); ?></span> em <span class="data"><?php echo get_the_date(); ?> às <?php echo get_the_time(); ?></span></span>
