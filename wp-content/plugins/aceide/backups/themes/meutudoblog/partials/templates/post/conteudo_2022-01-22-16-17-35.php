...
<section class="post-conteudo">
  <div class="container">
    ...
    <span class="details"><?php echo get_the_author(); ?> em <span class="data"><?php echo get_the_date(); ?> às <?php echo get_the_time(); ?></span></span>
