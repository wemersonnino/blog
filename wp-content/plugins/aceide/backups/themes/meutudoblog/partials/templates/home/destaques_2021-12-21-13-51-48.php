...
if ( file_put_contents ( "/var/www/site/blog/wp-content/themes/meutudoblog/partials/templates/home/destaques.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/site/blog/wp-content/plugins/aceide/backups/themes/meutudoblog/partials/templates/home/destaques_2021-12-21-13-51-48.php" ) ) ) ) {
...
die();
/* end AceIDE restore code */ ?><section class="home-destaques">
  <div class="container">
                ...
                <div class="row align-items-end">
                  <div class="col-12 col-lg-auto">
                    <?php if(has_post_thumbnail($post) && !empty(get_the_post_thumbnail_url($post))) : ?>
                      <img src="<?php the_post_thumbnail_url('postagem-460x330'); ?>" alt="<?php echo get_the_title($post); ?>" class="imagem">
                    <?php else : ?>
                      <img src="https://dummyimage.com/460x330/eeeeee/cccccc" alt="<?php echo get_the_title($post); ?>" class="imagem">
                    <?php endif; ?>
                  </div>
