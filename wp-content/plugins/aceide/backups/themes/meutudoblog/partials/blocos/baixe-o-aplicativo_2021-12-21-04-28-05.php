              ...
              <div class="badges">
                <?php if (get_field('link-app-store')) : ?>
                  <a href="<?php echo get_field('link-app-store'); ?>" target="_blank" class="badge">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/baixe-o-aplicativo-badge-app-store.png" alt="<?php _e('Baixe na App Store', 'meutudoblog'); ?>">
                  </a>
                <?php endif; ?>
                <?php if (get_field('link-google-play')) : ?>
                  <a href="<?php echo get_field('link-google-play'); ?>" target="_blank" class="badge">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/baixe-o-aplicativo-badge-google-play.png" alt="<?php _e('Baixe no Google Play', 'meutudoblog'); ?>">
                  </a>
                <?php endif; ?>
              </div>
            </div>
