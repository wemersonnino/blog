  ...
  <footer class="padrao">
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-4 col-lg">
          <p class="titulo"><?php echo get_field('credito')['titulo']; ?></p>
          <?php wp_nav_menu(array(
            'theme_location' => 'rodape-credito',
            'menu_class' => 'menu credito',
            'container' => false
          )); ?>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-auto text-center">
          <img src="<?php echo get_template_directory_uri(); ?>/images/rodape-padrao-logo-mcafee.png" width="185" height="67" alt="McAfee Secure" class="mcafee-logo">
        </div>
      </div>
    </div>
  </footer>
