      ...
      <div class="row">
        <div class="col-12 col-lg-4 text-center text-lg-left">
          <a href="<?php echo esc_url(get_home_url()); ?>/">
            <img src="<?php echo get_template_directory_uri(); ?>/images/rodape-padrao-logo.png" alt="<?php echo get_bloginfo('name'); ?>" class="logo">
          </a>
          ...
          <div class="d-none d-lg-block">
            <h2 class="titulo"><?php echo get_field('conquistas')['titulo']; ?></h2>
            <?php if (get_field('conquistas')['imagem']) : ?>
              <img src="<?php echo get_field('conquistas')['imagem']['url']; ?>" alt="<?php echo get_field('conquistas')['titulo']; ?>" class="conquistas-imagem">
            <?php endif; ?>
          </div>
        </div>
        ...
        <div class="col-12 col-md-5 col-lg-4">
          <h2 class="titulo"><?php echo get_field('contatos')['titulo']; ?></h2>
          <ul class="contatos">
        ...
        <div class="col-12 col-md-4 col-lg-3 offset-xl-1">
          <h2 class="titulo"><?php echo get_field('institucional')['titulo']; ?></h2>
