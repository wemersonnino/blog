...
class AdminPage extends XboxCore {
    ...
    public function __construct( $args = array() ){
        ...
        $this->args = wp_parse_args( $args, array(
            'id' => '',
            'title' => esc_html__( 'Admin Page', 'xbox' ),
            'menu_title' => esc_html__( 'Xbox Page', 'xbox' ),
            'parent' => false,
    ...
    */
    public function get_form( $form_options = array(), $echo = false ){
        ...
        $form .= "<input type='hidden' name='xbox_save_admin_page' value='true'>";
    ...
    */
    private function can_save_form(){
        if( ! isset( $_POST["xbox_save_admin_page"] ) && ! isset( $_POST['xbox-reset'] ) && ! isset( $_POST['xbox-import'] ) ){
            return false;
        }
