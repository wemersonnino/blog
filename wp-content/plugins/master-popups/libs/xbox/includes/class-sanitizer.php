...
class Sanitizer {
	...
	*/
	public function select(){
        ...
        if( $this->field->arg( 'options', 'multiple' ) ){
            ...
            $value = $this->validate_single_value( stripslashes( $this->value ), $valid_values, true );
        }
	...
	*/
	public function validate_multiple_values( $value = array(), $valid_values = null, $set_default = true ){
        ...
        //Importante para evitar valores que no están la lista de items, en caso de items eliminados posteriormente
