<?php
class Mpp_Infusionsoft_Service{

	public static function ping($serviceName, Mpp_Infusionsoft_App $app = null){
    ...
    protected static function getObjectOrDefaultAppIfNull(Mpp_Infusionsoft_App $app = null, Mpp_Infusionsoft_Generated_Base $object = null){
    	...
    	if($app == null){
	    	...
	    	if($object != null && $object->getAppPoolAppKey() != null){
				$app = Mpp_Infusionsoft_AppPool::getApp($object->getAppPoolAppKey());
			}
