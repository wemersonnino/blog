<?php
class Mpp_Infusionsoft_APIAffiliateService extends Mpp_Infusionsoft_APIAffiliateServiceBase{
    ...
    public static function affCommissions($affiliateId, $filterStartDate, $filterEndDate, Mpp_Infusionsoft_App $app = null) {
        ...
        foreach ($commissionData as $index => $commissionDatum) {
            ...
            $commission = new Mpp_Infusionsoft_Commission();
    ...
    public static function affClawbacks($affiliateId, $filterStartDate, $filterEndDate, Mpp_Infusionsoft_App $app = null) {
        ...
        foreach ($clawbacksData as $index => $clawbackDatum) {
            ...
            $clawback = new Mpp_Infusionsoft_Clawback();
