<?php
class Mpp_Infusionsoft_EmailService extends Mpp_Infusionsoft_Service{

    public static function attachEmail($contactId, $fromName, $fromAddress, $toAddress, $ccAddresses, $bccAddresses, $contentType, $subject, $htmlBody, $textBody, $header, $receivedDate, $sentDate, $emailSentType = 1, Mpp_Infusionsoft_App $app = null){
        $params = array(
            (int) $contactId,
            $fromName,
            $fromAddress,
    ...
    public static function sendEmailTemplate($contactList, $templateId, Mpp_Infusionsoft_App $app = null){
        $params = array(
            $contactList,
            (int) $templateId
        );
