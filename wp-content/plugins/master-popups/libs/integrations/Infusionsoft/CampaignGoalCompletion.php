...
class Mpp_Infusionsoft_CampaignGoalCompletion  extends Mpp_Infusionsoft_Generated_Base {
    ...
    public function save() {
        throw new Mpp_Infusionsoft_Exception("CampaignGoalCompletion cannot be saved since they are loaded from a saved search, and not accessible via the Data Service");
    }
