...
/**
    ...
    */
	...
	/**
    * Update the list from the contact list
    *
    * @section Contact List Related Methods
    *
    * @example bmeapi_listUpdate.php
    *
    * @param string listID - The contact list ID  which you want to update. To get the contact lists in your account, use the listGet method.
    * @param string listname - The listname which you want to update.
	* @param string listdescription - Update the new description of list.
    */

	 function listUpdate($listID, $listname, $listdescription) {
      $params = array();
      $params["listid"] = $listID;
      $params["listname"] = $listname;
      $params["listdescription"] = $listdescription;
      return $this->invokeMethod("listUpdate", $params);
    }
