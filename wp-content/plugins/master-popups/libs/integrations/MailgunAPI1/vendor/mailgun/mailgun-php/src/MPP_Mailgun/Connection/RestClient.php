...
namespace MPP_Mailgun\Connection;

use Http\Client\HttpClient;
use Http\Discovery\HttpClientDiscovery;
use Http\Discovery\MessageFactoryDiscovery;
use Http\Message\MultipartStream\MultipartStreamBuilder;
use MPP_Mailgun\Connection\Exceptions\GenericHTTPError;
use MPP_Mailgun\Connection\Exceptions\InvalidCredentials;
use MPP_Mailgun\Connection\Exceptions\MissingEndpoint;
use MPP_Mailgun\Connection\Exceptions\MissingRequiredParameters;
use MPP_Mailgun\Constants\Api;
use MPP_Mailgun\Constants\ExceptionMessages;
